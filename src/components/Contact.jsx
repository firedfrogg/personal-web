    ...
    return (
        <section className="section" id="contact">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a href={href} className="w-12 h-12 grid place-items-center ring-inset
                            ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color]
                            hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/50 reveal-up"
                            key={key}
                            target="_blank">
                                {icon}
                            </a>
                ...
                <form action="https://getform.io/f/bxojqlwa"
                ...
                method="POST">
                    ...
                    <div className="mb-4">
                        ...
                        placeholder="I Have Failed In My Role As A Sort Of Jiminy Cricket Figure.">
                        </textarea>
                    </div>
                    <button
